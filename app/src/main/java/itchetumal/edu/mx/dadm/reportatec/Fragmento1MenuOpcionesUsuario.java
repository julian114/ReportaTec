...
public class Fragmento1MenuOpcionesUsuario extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmento1_menu_opciones_usuario, container, false);
        ...
        viewPager= (ViewPager)view.findViewById(R.id.pagerFragmentoMenuOpcionesUsuario);
    ...
    public class ViewPageAdapter extends FragmentStatePagerAdapter {
        ...
        //arreglo para el titulo de las ventanas
        String[] tituloTabs = {"Enviados", "En espera", "Reportes Solucionados"};

        @Override
        public Fragment getItem(int position) {
            //retorna el fragmento dependiendo la posicion de la pestaña seleccionada
            switch (position){
                case 0: return new Fragmento1MenuUsuarioEnviados();
                case 1: return new Fragmento1MenuUsuarioEnEspera();
                case 2: return new Fragmento1MenuUsuarioSolucionados();
