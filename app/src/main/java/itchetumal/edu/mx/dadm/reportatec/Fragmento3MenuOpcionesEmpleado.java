...
public class Fragmento3MenuOpcionesEmpleado extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmento3_menu_opciones_empleado, container, false);
        ...
        viewPager= (ViewPager)view.findViewById(R.id.pagerFragmentoMenuOpcionesEmpleado);
    ...
    public class ViewPageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: return new Fragmento3MenuEmpleadoRecibidos();
                case 1: return new Fragmento3MenuEmpleadoPendientes();
                case 2: return new Fragmento3MenuEmpleadoSolucionados();
